...
func play_random_track() -> void:
	...
	unplayed_track_list[random_track_number].play()
...
func reset_tracks() -> void:
	...
	for track in already_played_track_list:
		unplayed_track_list.append(track)
#	unplayed_track_list = already_played_track_list
...
func on_electricity_enabled() -> void:
	pass

func on_electricity_disabled() -> void:
	pass
